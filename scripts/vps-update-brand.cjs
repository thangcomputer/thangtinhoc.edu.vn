...
sqlite3 prisma/dev.db "UPDATE SystemSetting SET value='Thắng Tin Học' WHERE key='site_name';"
sqlite3 prisma/dev.db "UPDATE SystemSetting SET value='© 2026 Thắng Tin Học' WHERE key='footer_text';"
sqlite3 prisma/dev.db "INSERT OR IGNORE INTO SystemSetting (key,value) VALUES ('site_name','Thắng Tin Học');"
sqlite3 prisma/dev.db "INSERT OR IGNORE INTO SystemSetting (key,value) VALUES ('footer_text','© 2026 Thắng Tin Học');"
echo "=== After update ==="
sqlite3 prisma/dev.db "SELECT key,value FROM SystemSetting WHERE key IN ('site_name','footer_text','site_description');"
echo
