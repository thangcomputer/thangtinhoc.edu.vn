...
export default function PostForm() {
  ...
  // Smart suggestions database (Hot News & Trending IT topics)
  const SUGGESTION_DB = [
    'ChatGPT và Copilot thay đổi cách làm việc văn phòng như thế nào?',
    'Tính năng mới nhất của Microsoft Excel năm nay',
    'So sánh Gemini và ChatGPT: Đâu là trợ lý AI tốt nhất cho dân văn phòng?',
    'Bản cập nhật Windows mới nhất có gì đặc biệt?',
    'Các công cụ AI tạo slide PowerPoint tự động đỉnh nhất',
    'Những kỹ năng tin học nhà tuyển dụng tìm kiếm nhiều nhất',
    'Ứng dụng AI vào tự động hóa báo cáo dữ liệu',
    'Sự thật về chứng chỉ tin học MOS và IC3 hiện nay',
    'Xu hướng làm việc từ xa và các công cụ hỗ trợ trực tuyến',
    'Lỗ hổng bảo mật mới cần chú ý khi lưu trữ đám mây',
    'Cảnh báo các hình thức lừa đảo qua mạng mới nhất',
    'Cách dùng AI để tối ưu hóa công việc hàng ngày',
    'Tương lai của nghề kế toán khi có sự xuất hiện của AI',
    'Đánh giá nhanh phần mềm Office bản quyền mới nhất',
    'Canva ra mắt tính năng AI mới: Có thay thế được Photoshop?',
    'Mẹo quản lý thời gian và tăng năng suất với Notion',
  ];
